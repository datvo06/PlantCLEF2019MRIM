...
if __name__ == '__main__':
    list_classes = list(open('/video/clef/LifeCLEF/PlantCLEF2019/train/list.txt', 'r'))
    list_classes = [classname.split('/')[1][:-1] for classname in list_classes]
    mapping_dict, class_images = get_all_images_path('/video/clef/LifeCLEF/PlantCLEF2019/train/data', list_classes)
    pkl.dump((mapping_dict, class_images), open('train_set.pkl', 'wb'))
